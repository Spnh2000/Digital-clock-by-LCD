...
char str_second[1],str_minute[1],str_hour[1],str_HofSecond[1];
...
// Output Pulse(s):
// OC1A Period: 20.5 ms Width: 20.5 ms
...
while (1)
      ...
      // Place your code here 
       lcd_gotoxy(3,1);
       itoa(hours,str_hour);lcd_puts(str_hour); lcd_putchar(' ');
       lcd_gotoxy(6,1);
       lcd_putchar(':');
       lcd_gotoxy(7,1);
       itoa(minutes,str_minute);lcd_puts(str_minute); lcd_putchar(' ');
       lcd_gotoxy(9,1);
       lcd_putchar(':'); 
       lcd_gotoxy(10,1);
       itoa(seconds,str_second);lcd_puts(str_second); lcd_putchar(' ');
       lcd_gotoxy(12,1);
       lcd_putchar(':'); 
       lcd_gotoxy(13,1);
       itoa(HofSeconds,str_HofSecond);lcd_puts(str_HofSecond); lcd_putchar(' ');
      }
}
